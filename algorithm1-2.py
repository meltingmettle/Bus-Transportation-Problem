...
# different folder
###########################################
path_to_outputs = "./alg_1_and_2_outputs"
...
def solve(graph, num_buses, size_bus, constraints):
    ...
    # add 1 random person to each bus THESE CAN BE CLUSTERED: some people who are least connected to each other
    for i in range(num_buses):
...
def solve2(graph, num_buses, size_bus, constraints):
    print('start')
    #TODO: Write this method as you like. We'd recommend changing the arguments here as well
    #helpers
    def find_best_bus(node):
...
def main():
    ...
    for size in size_categories:
        ...
        for input_folder in os.listdir(category_dir):
            ...
            for i in range(5):
                graph, num_buses, size_bus, constraints = parse_input(category_path + "/" + input_name)
                new_solution = solve(graph, num_buses, size_bus, constraints)
            ...
            for i in range(5):
                graph, num_buses, size_bus, constraints = parse_input(category_path + "/" + input_name)
                new_solution = solve2(graph, num_buses, size_bus, constraints)
                new_score = score(new_solution)
                if new_score > Score:
                    Score = new_score
                    solution = new_solution
